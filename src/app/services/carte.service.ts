...
export class CarteService {
  private cartes:Carte[] = [
    ...
    {id: '3.1',imageUrl: '/assets/couscous.png',titre: 'Couscous',description: 'Le couscous est le plat traditionnel tunisien particulièrement pour les cérémonies. Il est préparé à base de semoule travaillée et cuite à la vapeur mais dont il est servi le plus souvent avec un ragoût de légumes pouvant être accompagné de viande rouge, blanche ou de poisson.',adresse: 'Au bon vieux temps,Restaurant Dar Slah,Fondouk El Attarine'},
    {id: '3.2',imageUrl: '/assets/lablebi.png',titre: 'Lablebi',description: 'est un plat populaire en Tunisie,préparé à base de pois chiches, d"ail, de cumin ou de carvi, d"huile d"olive, de sel, de poivre et de la harissa.',adresse: 'Mounir Lablebi,Labloub,Ayem Zamen'},
    {id: '3.3',imageUrl: '/assets/charmoula.png',titre: 'Charmoula',description: 'La Charmoula (ou Chermoula), est une sauce sucrée qui accompagne le poisson salé servi lors du premier repas de l"Aïd el Fitr.',adresse: 'Hlouwa,Maison Gourmandise,Boutique Maison Turki'},

    {id: '3.4',imageUrl: '/assets/kafteji.png',titre: 'Kafteji',description: ' est un plat populaire en Tunisie, Le kafteji est un plat composé principalement de légumes et il est épicé et pimenté,le plat est traditionnellement accompagné de foie ou de merguez grillées ou encore d"un œuf frit.',adresse: 'Restaurant Tounsi,Kafteji Choko,Kafteji&Mraweb chez Haboub'},
    {id: '3.5',imageUrl: '/assets/kamounia.png',titre: 'Kamounia',description: ' La Kamounia est l’une des plats les plus raffinés de la gastronomie tunisienne.Il s"agit d"un plat en sauce,préparé à base d"abats ou de fruits de mer .',adresse: 'Resto Lella Fatma,El foundou,Dar El jeld'},
    {id: '3.6',imageUrl: '/assets/madfouna.png',titre: 'Madfouna',description: 'La madfouna, un pain plat fourré composé d"une grande variété de viandes, de noix, de légumes, d"herbes et d"épices',adresse: 'Bnina.tn,Madfouna.tn'},
    
    {id: '3.7',imageUrl: '/assets/kaak warka.png',titre: 'Kaak Warka',description: 'Le kâak warka est une pâtisserie tunisienne à base de farine, de sucre glace, de beurre et d"amandes en poudre auquel peut être ajouté de l"eau florale',adresse: 'Patisserie Mme Sakka,Patisserie Masmoudi'},
    {id: '3.8',imageUrl: '/assets/ourta.png',titre: 'Ourta',description: 'Ourta, un gâteau tunisien aux feuilles de brik et fruits secs. Une douceur ramadanesque.',adresse: 'Maison Hachicha,Gourmandise'},
    {id: '3.9',imageUrl: '/assets/mahkouka.png',titre: 'Mahkouka',description:'est une patisserie tunisienne constituée principalement de dattes,de semoule et de fruits secs.',adresse: 'Maison Hachicha ,Madame Najet'},
  
    // cartes vetement (id commence par 4.x)
    {id: '4.1',imageUrl: '/assets/burnous.png',titre: 'Burnous',description: 'Le burnous, une pièce maîtresse de la culture tunisienne, est ici revisité pour s"adapter aux goûts modernes',adresse: 'Dar El Jebba Sellami Artisanat, JAS & JOES,Bluz Tunisie'},
    {id: '4.2',imageUrl: '/assets/houli.png',titre: 'Houli',description: 'un vetement traditionnel féminin,souvent porté lors de mariages et d"occasions spéciales. Il se compose d"une robe longue et fluide,en soie ou en satin, ornée de broderies et de perles',adresse: 'Houli Saoud,Tunisian Dress by saloua, Artounsi'},
    {id: '4.3',imageUrl: '/assets/shashya.png',titre: 'Chachia',description: 'La chéchia traditionnelle est faite de laine peignée et tricotée. Elle est naturellement dotée d"une texture souple',adresse: 'Souk Chaouachin,Artisans d"Art,Chechia Store'},

    {id : '4.4',imageUrl: '/assets/robe djerbienne.png',titre: 'Robe Djerbienne',description: 'Costume de la mariée d"Ajim.Robe-drapé de soie rayé',adresse: 'Abir mode vente et location , Boutique La Perla Caftan Houmt Souk'},
    {id : '4.5',imageUrl: '/assets/jebba.png',titre: 'Jebba',description: 'La jebba est un vêtement ample qui constitue la pièce principale de la tenue traditionnelle masculine en Tunisie ,fabriqué en laine, mais aussi en soie ou en lin',adresse: 'L"homme by Gharsallah,Pacha Collection'},
    {id : '4.6',imageUrl: '/assets/qmejja mestiri.png',titre: 'Qmeja Mestiri ',description: 'Qmejja mestiri Ouardanine Costume de la jelwa (Cérémonie de mariage) à grandes ailes Velours et brocart richement brodés ',adresse: 'Trésor,Location vetements traditionnels'},

    {id: '4.7',imageUrl: '/assets/akri hammamet.png',titre: 'Akri Hammamet',description: 'La Jebba Akri Hammamet XIXe siècle et début XXe siècle Costume de cérémonie de mariage Tunique de laine fine bicolore (Noire et Rouge)',adresse: 'Habits traditionnels by Nadia,Espace Nada Boudhina'},
    {id: '4.8',imageUrl: '/assets/safseri.png',titre: 'Safseri',description: 'est un voile traditionnel féminin,Il est en général de couleur crème en coton, satin ou soie',adresse: 'Hraier,Tej Alik,Artisana'},
    {id: '4.9',imageUrl: '/assets/balgha.png',titre: 'Balgha',description: 'est une chaussure en cuir qui fait partie des costumes traditionnels',adresse: 'artisansdart.tn ,Souk Blaghjia,artisana '}
  ];
