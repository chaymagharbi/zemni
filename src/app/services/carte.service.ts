...
export class CarteService {
  private cartes:Carte[] = [
    ...
    {id: '3.2',imageUrl: '/assets/leblebii.jpg',titre: 'Lablebi',description: 'est un plat populaire en Tunisie,préparé à base de pois chiches, d"ail, de cumin ou de carvi, d"huile d"olive, de sel, de poivre et de la harissa.',adresse: 'Mounir Lablebi,Labloub,Ayem Zamen'},
    ...
    {id: '3.4',imageUrl: '/assets/kafteji.jpg',titre: 'Kafteji',description: ' est un plat populaire en Tunisie, Le kafteji est un plat composé principalement de légumes et il est épicé et pimenté,le plat est traditionnellement accompagné de foie ou de merguez grillées ou encore d"un œuf frit.',adresse: 'Restaurant Tounsi,Kafteji Choko,Kafteji&Mraweb chez Haboub'},
    {id: '3.5',imageUrl: '/assets/kamouniaa.jpg',titre: 'Kamounia',description: ' La Kamounia est l’une des plats les plus raffinés de la gastronomie tunisienne.Il s"agit d"un plat en sauce,préparé à base d"abats ou de fruits de mer .',adresse: 'Resto Lella Fatma,El foundou,Dar El jeld'},
    ...
    {id: '3.7',imageUrl: '/assets/kaak.jpg',titre: 'Kaak Warka',description: 'Le kâak warka est une pâtisserie tunisienne à base de farine, de sucre glace, de beurre et d"amandes en poudre auquel peut être ajouté de l"eau florale',adresse: 'Patisserie Mme Sakka,Patisserie Masmoudi'},
    ...
    {id: '4.1',imageUrl: '/assets/barnouss.jpg',titre: 'Burnous',description: 'Le burnous, une pièce maîtresse de la culture tunisienne, est ici revisité pour s"adapter aux goûts modernes',adresse: 'Dar El Jebba Sellami Artisanat, JAS & JOES,Bluz Tunisie'},
    {id: '4.2',imageUrl: '/assets/houlii.jpg',titre: 'Houli',description: 'un vetement traditionnel féminin,souvent porté lors de mariages et d"occasions spéciales. Il se compose d"une robe longue et fluide,en soie ou en satin, ornée de broderies et de perles',adresse: 'Houli Saoud,Tunisian Dress by saloua, Artounsi'},
    {id: '4.3',imageUrl: '/assets/chachiyya.avif',titre: 'Chachia',description: 'La chéchia traditionnelle est faite de laine peignée et tricotée. Elle est naturellement dotée d"une texture souple',adresse: 'Souk Chaouachin,Artisans d"Art,Chechia Store'},
    ...
    {id : '4.5',imageUrl: '/assets/jebbaa.jpg',titre: 'Jebba',description: 'La jebba est un vêtement ample qui constitue la pièce principale de la tenue traditionnelle masculine en Tunisie ,fabriqué en laine, mais aussi en soie ou en lin',adresse: 'L"homme by Gharsallah,Pacha Collection'},
    ...
    {id: '4.7',imageUrl: '/assets/akri.jpg',titre: 'Akri Hammamet',description: 'La Jebba Akri Hammamet XIXe siècle et début XXe siècle Costume de cérémonie de mariage Tunique de laine fine bicolore (Noire et Rouge)',adresse: 'Habits traditionnels by Nadia,Espace Nada Boudhina'},
    {id: '4.8',imageUrl: '/assets/sefserii.jpg',titre: 'Safseri',description: 'est un voile traditionnel féminin,Il est en général de couleur crème en coton, satin ou soie',adresse: 'Hraier,Tej Alik,Artisana'},
    {id: '4.9',imageUrl: '/assets/balghaa.jpg',titre: 'Balgha',description: 'est une chaussure en cuir qui fait partie des costumes traditionnels',adresse: 'artisansdart.tn ,Souk Blaghjia,artisana '}
  ];
